    ...
    <main className='bg-[#faf8f2]'>
      <div
        ...
        <div className="h-screen  bg-gradient-to-t from-black to-trasparent flex items-center justify-around bg-left  flex-col">
          ...
          <div className=" flex flex-col items-center  ">
            <span className="text-white font-commissioner">Ver más</span>
            <svg
      ...
      <section className="md:py-16 md:px-16 md:mt-[-15rem] mt-[-5rem] flex md:flex-row flex-col  md:gap-16 " >
        <div className="flex flex-col items-center  md:w-2/3">
          ...
          <div className="flex md:flex-row w-full flex-col justify-between py-8 font-commissioner">
        ...
        <div className=" flex flex-col md:w-1/3 text-xl justify-center items-center pt-8 font-commissioner " >
          <div className="flex flex-col text-center pb-8">

            <h5 className="font-didot md:text-6xl md:pt-12 pb-4">Horario</h5>
          ...
          <div className="flex flex-col text-center pb-">
            ...
            <h5 className="font-didot md:text-6xl pb-4">Teléfono</h5>
