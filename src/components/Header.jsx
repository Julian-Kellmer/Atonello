...
const Header = () => {
  ...
  return (
    <>
      <header className="bg-[rgb(22,22,22)] w-full">
        <nav className="flex justify-between overflow-hidden">
          <div className="flex flex-col text-center px-8 py-4 md:px-16 py-6 text-white">
            <Link to="/">
          ...
          <div
            id="navBar"
            className={`nav-links md:block bg-[#161616] absolute md:relative mt-5 md:min-h-fit top-[8%] left-0 flex items-center transition-all duration-300 ease-in-out ${
